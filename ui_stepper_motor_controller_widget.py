...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(u"icons/disconnect.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonDisconnect.setIcon(icon)
        self.pushButtonDisconnect.setIconSize(QSize(24, 24))
        self.widget = QWidget(Form)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 10, 541, 421))
        ...
        icon1 = QIcon()
        icon1.addFile(u"icons/refresh.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"icons/connect.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonConnect.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u"icons/start_motor.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonStartMotor.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u"icons/stop_motor.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonStopMotor.setIcon(icon4)
        self.pushButtonStopMotor.setIconSize(QSize(24, 24))

        self.horizontalLayout_3.addWidget(self.pushButtonStopMotor)

        self.pushButtonPoweroffMotor = QPushButton(self.widget)
        ...
        icon5 = QIcon()
        icon5.addFile(u"icons/poweroff.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonPoweroffMotor.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u"icons/set_zero.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonSetZero.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u"icons/check_state.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonCheckState.setIcon(icon7)
        self.pushButtonCheckState.setIconSize(QSize(24, 24))

        self.horizontalLayout_4.addWidget(self.pushButtonCheckState)

        self.pushButtonMeasure = QPushButton(self.widget)
        ...
        icon8 = QIcon()
        icon8.addFile(u"icons/measure.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonMeasure.setIcon(icon8)
        ...
        self.widget1.setGeometry(QRect(10, 10, 208, 86))
        self.gridLayout_2 = QGridLayout(self.widget1)
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.labelControlVelocity = QLabel(self.widget1)
        ...
        self.comboBoxMovementUnits = QComboBox(self.widget1)
        ...
        self.comboBoxVelocityUnits = QComboBox(self.widget1)
        ...
        self.doubleSpinBoxMoveTo = QDoubleSpinBox(self.widget1)
        ...
        self.textEditMessage = QTextEdit(self.widget)
        ...
        icon9 = QIcon()
        icon9.addFile(u"icons/send.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButtonSend.setIcon(icon9)
